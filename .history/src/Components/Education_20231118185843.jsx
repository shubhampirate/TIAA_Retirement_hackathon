...
<AppBar position="absolute" open={open} sx={{ backgroundColor: "whitesmoke", boxShadow: 'none' }}>
  ...
  <Title variant="h4" sx={{color: "#042A57"}}>
            ...
            <Grid container spacing={3}>
            <iframe width="560" height="315" src="https://www.youtube.com/embed/X3qyxo_UTR4?si=M7YwsCQVvrNubbM_" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
