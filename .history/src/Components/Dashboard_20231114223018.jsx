...
export default function Dashboard() {
  ...
  >
    ...
    <Grid container spacing={2} alignItems="center">
      ...
      <Grid item xs={12} md={6} sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
        <Button variant="contained" color="primary" sx={{ width: '100%',backgroundColor: '#0066FF', color: '#fff', mb: 1 }}>
         PLan Your Retirement
        </Button>
        <Button variant="contained" color="secondary" sx={{ width: '100%', backgroundColor: '#0066FF', color: '#fff', }}>
  ...
  >
    {/* Hello Ramesh with a waving hand symbol */}
