...
const [videolinks,setVideolinks] = useState([]);
  const searchYouTube = async (q) => {
    ...
    console.log(body);
    // setVideolinks(body.data.videos);
    console.log(body.videos.title)
    return body.data
    // setSearchResults(body.items.filter((item) => item.type=== 'videos'));
    // setVideolinks(body.filter((item) => item.type=== 'videos'));
    // console.log(searchResults)

    // if (body.data && body.data.videos) {
    //     setSearchResults(body.data.videos);
    //   } else {
    //     setSearchResults([]); // Set empty array if 'videos' not found
    //   }
    //   console.log(searchResults)
  };
