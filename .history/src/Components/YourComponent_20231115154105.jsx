...
const InvestmentsBox = () => (
  <Paper sx={{ pt: 4,pb:2, pl:3, pr:3 display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
...
const ProgressBarBox = ({ title, value }) => {
  ...
  const CreditScoreBox = () => (
    <Paper sx={{ p: 2, display: 'flex', flexDirection: 'column', alignItems: 'center', position: 'relative' }}>
      <Typography variant="h6" sx={{mb:{xs:0, md:2}, color: "#042A57", fontSize: "16px", fontWeight: "bold"}}>YOUR CREDIT SCORE</Typography>
      {/* <br /> */}
