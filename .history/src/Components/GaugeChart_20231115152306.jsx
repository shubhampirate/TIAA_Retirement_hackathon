      ...
      <div className="gauge-box" data-percent='88'>
        <svg version="1.1" style={{ maxHeight: '100%', maxWidth: '100%' }} className="gauge-meter-chart" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px"
          ...
          <g className="meter">
            ...
            <path className="p-2" fill="#F7F616" d="M14.7,14.9c-4.3,4.4-7.8,9.5-10.2,15.2l10.6,4.4c1.9-4.3,4.5-8.2,7.7-11.5L14.7,14.9z"/>
            <path className="p-3" fill="#F7F616" d="M30.6,4c-5.7,2.4-10.9,5.9-15.2,10.2l8.1,8.1c3.3-3.2,7.2-5.9,11.5-7.7L30.6,4z"/>
            <path className="p-4" fill="#3CFF2A" d="M49.5,0c-6.3,0.1-12.4,1.3-18,3.6l4.4,10.6c4.2-1.7,8.8-2.6,13.6-2.7V0z"/>
            <path className="p-5" fill="#3CFF2A" d="M68.5,3.6c-5.6-2.2-11.6-3.5-18-3.6v11.5c4.8,0.1,9.4,1,13.6,2.7L68.5,3.6z"/>
            <path className="p-6" fill="#3CDD2A" d="M84.6,14.2C80.3,9.9,75.1,6.4,69.4,4L65,14.6c4.3,1.9,8.2,4.5,11.5,7.7L84.6,14.2z"/>
            <path className="p-7" fill="#3CDD2A" d="M95.5,30.1c-2.4-5.7-5.9-10.9-10.2-15.2L77.2,23c3.2,3.3,5.9,7.2,7.7,11.5L95.5,30.1z"/>
            <path className="p-8" fill="#1B5EB2" d="M99,42.4c-0.6-4-1.6-7.8-3.1-11.4l-10.6,4.4c1.1,2.8,1.9,5.7,2.3,8.7C88,47,90.5,49,93.3,49h0C96.8,49,99.5,45.9,99,42.4z"/>
          </g>
