...
const healthTopics = [
  ...
  const CalculateMediclaimTabContent = ({ label, content }) => {
    ...
    const  healthinsurance = 500000;
      ...
      const totalBills =  total + bills.reduce((bill) => parseFloat(bill.amount), 0);
      ...
      const finalAmount = total - roomChargesSurplus - doctorChargesSurplus;
    ...
    <div>
      <Typography mb={1} mt={1} ml={1}>15% Deduction:</Typography>
      <TextField
        disabled
