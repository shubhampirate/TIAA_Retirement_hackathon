...
const EquityMarketsBox = () => {
  ...
  return (
    <Paper sx={{ p: 2, display: 'flex', flexDirection: 'column' }}>
      ...
      {/* Display market values in a table */}
      <table>
        <tbody>
          {marketData.map((market) => (
            <tr key={market.name}>
              ...
              <td style={{ color: market.increasePercentage >= 0 ? 'green' : 'red' }}>
      ...
      {/* "See All" link */}
      <Typography variant="subtitle1" style={{ alignSelf: 'flex-end', marginTop: '10px', cursor: 'pointer' }}>
        See All
      </Typography>
    </Paper>
  );
