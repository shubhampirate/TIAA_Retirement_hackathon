      ...
      <Grid item xs={12} sm={6} md={4}>
        ...
        >
          ...
          <LinearProgress
            variant="determinate"
            value={value}
            sx={{ width: '100%', height: '12px', borderRadius: '8px', backgroundColor: '#f0f0f0', marginBottom: '8px' }}
          />
          <Box
            sx={{
              display: 'flex',
          ...
          >
            ...
            <Typography variant="body2">Nearby Full</Typography>
            <Typography variant="body2">Completely Full</Typography>
          </Box>
          <Typography variant="body2" sx={{ mt: 1, color: color }}>
  ...
  <Title variant="h4" sx={{color: "#042A57"}}>
        ...
        >
          ...
          <LinearProgress
            variant="determinate"
            value={60}
            sx={{ width: '100%', height: '12px', borderRadius: '8px', backgroundColor: '#f0f0f0' }}
          />
          <Box
            sx={{
              display: 'flex',
          ...
          >
            <Typography variant="body2">Less</Typography>
            <Typography variant="body2">half Full</Typography>
            <Typography variant="body2">Completely Full</Typography>
          </Box>
