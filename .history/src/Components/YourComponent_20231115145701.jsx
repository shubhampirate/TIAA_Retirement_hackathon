...
const InvestmentsBox = () => (
  <Paper sx={{ p: 4, display: 'flex', flexDirection: 'column', alignItems: 'center',borderRadius: '16px', }}>
    <div style={{ display: 'flex', justifyContent: 'space-between', width: '100%' }}>
      <div style={{ textAlign: 'left' }}>
        <Typography variant="h5" sx={{color: '#0066FF' }}>Your Investments</Typography>
        <Typography variant="h6" sx={{mt:2}}>$120,000</Typography>
        ...
        <Button variant="contained"  sx={{ width: '100%', backgroundColor: '#0066FF', color: '#fff', mb:1 ,mt:{xs:0, md:2}  }}>
        Detailed Investments
        </Button>
      </div>
      {/* Chart (replace with your actual chart component) */}
      <div style={{ width: '50%', height: '150px', backgroundColor: '#fff' }}>
...
const ProgressBarBox = ({ title, value }) => {
  ...
  const CreditScoreBox = () => (
    <Paper sx={{ p: 2, display: 'flex', flexDirection: 'column', alignItems: 'center', position: 'relative', borderRadius: '16px' }}>
      <Typography variant="h6" sx={{mb:{xs:0, md:2}, color: "#042A57"}}>YOUR CREDIT SCORE</Typography>
      {/* <br /> */}
      {/* Circular Progress Bar */}
      <div style={{ position: 'relative', width: '80px', height: '80px', marginBottom:"35px" }}>
...
const YourComponent = () => (
  ...
  <Grid item xs={12} md={9} sx={{borderRadius: '16px'}}>
    <Grid container spacing={2} style={{ height: '100%', borderRadius: '16px', }}>
