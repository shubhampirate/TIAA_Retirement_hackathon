    ...
    <Grid container spacing={3}>
      ...
      <Grid item xs={12}>
        <Paper sx={{ p: 3, borderRadius: '16px' }}>
          {/* Editable Account Picture, Username, and DOB */}
          <Box sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
            ...
            <TextField
              ...
              fullWidth
              margin="normal"
              defaultValue="Dummy Username"
              InputProps={{
                endAdornment: (
                  <IconButton color="primary" onClick={() => handleEdit('username')}>
                    <EditIcon />
                  </IconButton>
                ),
              }}
            ...
            <TextField
              ...
              InputProps={{
                endAdornment: (
                  <IconButton color="primary" onClick={() => handleEdit('dob')}>
                    <EditIcon />
                  </IconButton>
                ),
              }}
      ...
      <Grid item xs={12} md={6}>
        <Paper sx={{ p: 3, borderRadius: '16px' }}>
          {/* Editable First Name, Last Name, Email, and Password */}
          <Box>
            <TextField
              label="First Name"
              variant="outlined"
              fullWidth
              margin="normal"
              defaultValue="Dummy First Name"
              InputProps={{
                endAdornment: (
                  <IconButton color="primary" onClick={() => handleEdit('firstName')}>
                    <EditIcon />
                  </IconButton>
                ),
              }}
            ...
            <TextField
              ...
              fullWidth
              margin="normal"
              defaultValue="Dummy Last Name"
              InputProps={{
                endAdornment: (
                  <IconButton color="primary" onClick={() => handleEdit('lastName')}>
                    <EditIcon />
                  </IconButton>
                ),
              }}
            ...
            <TextField
              ...
              InputProps={{
                endAdornment: (
                  <IconButton color="primary" onClick={() => handleEdit('email')}>
                    <EditIcon />
                  </IconButton>
                ),
              }}
