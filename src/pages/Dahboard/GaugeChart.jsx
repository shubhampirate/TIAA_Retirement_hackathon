  ...
  return (
    <div style={{ position: 'absolute', maxWidth: '80%', top: '50%', left: '50%', width: '300px', transform: 'translate(-50%, -50%)', boxShadow: '0px 5px 20px rgba(0,0,0,0.2)', padding: '20px', borderRadius: '5px' }}>
      <div className="gauge-box" data-percent='88'>
        <svg version="1.1" style={{ maxHeight: '100%', maxWidth: '100%', enableBackground: 'new 0 0 100 51' }} className="gauge-meter-chart" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px"
          y="0px" viewBox="0 0 100 51" xmlSpace="preserve">
          <g className="meter">
